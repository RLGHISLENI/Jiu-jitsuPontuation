  ...
  return (
    <div className="relative">
      ...
      <div className="flex flex-col items-center justify-center gap-8 
        ...
        <div className="w-64 2xl:w-96 3xl:w-80 tv-lg:w-[35rem] tv-4k:w-[42rem]">
        ...
        <div className="bg-gray-100 w-96 tv-4k:w-[60rem] tv-lg:w-[45rem] text-black text-center font-bold rounded-lg
          ...
          <p className="text-8xl font-extrabold
                         2xl:text-9xl tv-4k:text-15xl tv-lg:text-10xl">
            {time}
          </p>
          <p className="text-lg mt-2
                         2xl:text-xl 3xl:text-2xl tv-4k:text-5xl tv-lg:text-5xl">
            Clique para definir o tempo
          </p>
        </div>

        {/* TotalScoreCard inferior - crescimento moderado */}
        <div className="w-64 2xl:w-96 3xl:w-80 tv-4k:w-[42rem] tv-lg:w-[35rem]">
