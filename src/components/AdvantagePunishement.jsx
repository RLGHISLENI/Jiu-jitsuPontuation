...
export default function AdvantagePunishement({
  ...
  return (
    <div className="grid grid-cols-1 w-24 md:flex md:flex-col md:items-center md:w-auto mt-28 2xl:mt-48 tv-4k:gap-2 tv-4k:w-96 tv-4k:mt-[30rem] tv-lg:gap-1 tv-lg:w-64 tv-lg:mt-[18rem]">
