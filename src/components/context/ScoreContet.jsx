...
export const ScoreProvider = ({ children }) => {
  ...
  const handlePunishement = (player, isPunishment) => {
    if (player === "Lutador 1") {
      if (isPunishment) setPunishementValue1((prev) => prev + 1);
      else setVantagemValue1((prev) => prev + 1);
    } else if (player === "Lutador 2") {
      if (isPunishment) setPunishementValue2((prev) => prev + 1);
      else setVantagemValue2((prev) => prev + 1);
    }
  };
